...
function _classCallCheck(n, e) {
  ...
  function n(n, e) {
    for (var i = 0; i < e.length; i++) {
      var t = e[i];t.enumerable = t.enumerable || !1, t.configurable = !0, "value" in t && (t.writable = !0), Object.defineProperty(n, t.key, t);
    }
  ...
  var e = function () {
    function e(i, t) {
      _classCallCheck(this, e), this.$element = i, this.options = n.extend({}, e.defaults, this.$element.data(), t), Foundation.Nest.Feather(this.$element, "accordion"), this._init(), Foundation.registerPlugin(this, "AccordionMenu"), Foundation.Keyboard.register("AccordionMenu", { ENTER: "toggle", SPACE: "toggle", ARROW_RIGHT: "open", ARROW_UP: "up", ARROW_DOWN: "down", ARROW_LEFT: "close", ESCAPE: "closeAll" });
        ...
        this.$element.find("[data-submenu]").not(".is-active").slideUp(0), this.$element.attr({ role: "menu", "aria-multiselectable": this.options.multiOpen }), this.$menuLinks = this.$element.find(".is-accordion-submenu-parent"), this.$menuLinks.each(function () {
          var e = this.id || Foundation.GetYoDigits(6, "acc-menu-link"),
              i = n(this),
              t = i.children("[data-submenu]"),
              a = t[0].id || Foundation.GetYoDigits(6, "acc-menu"),
              s = t.hasClass("is-active");i.attr({ "aria-controls": a, "aria-expanded": s, role: "menuitem", id: e }), t.attr({ "aria-labelledby": e, "aria-hidden": !s, role: "menu", id: a });
        ...
        var e = this;this.$element.find("li").each(function () {
          var i = n(this).children("[data-submenu]");i.length && n(this).children("a").off("click.zf.accordionMenu").on("click.zf.accordionMenu", function (n) {
            n.preventDefault(), e.toggle(i);
          });
          ...
          var t,
            ...
            if (n(this).is(s)) return t = o.eq(Math.max(0, e - 1)).find("a").first(), a = o.eq(Math.min(e + 1, o.length - 1)).find("a").first(), n(this).children("[data-submenu]:visible").length && (a = s.find("li:first-child").find("a").first()), n(this).is(":first-child") ? t = s.parents("li").first().find("a").first() : t.parents("li").first().children("[data-submenu]:visible").length && (t = t.parents("li").find("li:last-child").find("a").first()), void (n(this).is(":last-child") && (a = s.parents("li").first().next("li").find("a").first()));
              ...
              e.hideAll();
            }, handled: function handled(n) {
              n && i.preventDefault(), i.stopImmediatePropagation();
            } });
        });
      ...
      } }, { key: "toggle", value: function value(n) {
        n.is(":animated") || (n.is(":hidden") ? this.down(n) : this.up(n));
      } }, { key: "down", value: function value(n) {
        var e = this;this.options.multiOpen || this.up(this.$element.find(".is-active").not(n.parentsUntil(this.$element).add(n))), n.addClass("is-active").attr({ "aria-hidden": !1 }).parent(".is-accordion-submenu-parent").attr({ "aria-expanded": !0 }), n.slideDown(e.options.slideSpeed, function () {
          e.$element.trigger("down.zf.accordionMenu", [n]);
        });
      } }, { key: "up", value: function value(n) {
        var e = this;n.slideUp(e.options.slideSpeed, function () {
          e.$element.trigger("up.zf.accordionMenu", [n]);
        });var i = n.find("[data-submenu]").slideUp(0).addBack().attr("aria-hidden", !0);i.parent(".is-accordion-submenu-parent").attr("aria-expanded", !1);
...
!function (t) {
  ...
  function n(t) {
    if (void 0 === Function.prototype.name) {
      var n = /function\s([^(]{1,})\(/,
          i = n.exec(t.toString());return i && i.length > 1 ? i[1].trim() : "";
    ...
    return t.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase();
      ...
      r = { version: o, _plugins: {}, _uuids: [], rtl: function rtl() {
      return "rtl" === t("html").attr("dir");
    }, plugin: function plugin(t, i) {
      var o = i || n(t),
          r = e(o);this._plugins[r] = this[o] = t;
    }, registerPlugin: function registerPlugin(t, i) {
      var o = i ? e(i) : n(t.constructor).toLowerCase();t.uuid = this.GetYoDigits(6, o), t.$element.attr("data-" + o) || t.$element.attr("data-" + o, t.uuid), t.$element.data("zfPlugin") || t.$element.data("zfPlugin", t), t.$element.trigger("init.zf." + o), this._uuids.push(t.uuid);
    }, unregisterPlugin: function unregisterPlugin(t) {
      var i = e(n(t.$element.data("zfPlugin").constructor));this._uuids.splice(this._uuids.indexOf(t.uuid), 1), t.$element.removeAttr("data-" + i).removeData("zfPlugin").trigger("destroyed.zf." + i);for (var o in t) {
        t[o] = null;
      }
    }, reInit: function reInit(n) {
      var i = n instanceof t;try {
        if (i) n.each(function () {
          t(this).data("zfPlugin")._init();
        });else {
          var o = typeof n === "undefined" ? "undefined" : _typeof(n),
              r = this,
              a = { object: function object(n) {
              n.forEach(function (n) {
                n = e(n), t("[data-" + n + "]").foundation("_init");
              });
    ...
    }, GetYoDigits: function GetYoDigits(t, n) {
      return t = t || 6, Math.round(Math.pow(36, t + 1) - Math.random() * Math.pow(36, t)).toString(36).slice(1) + (n ? "-" + n : "");
    }, reflow: function reflow(n, e) {
      "undefined" == typeof e ? e = Object.keys(this._plugins) : "string" == typeof e && (e = [e]);var o = this;t.each(e, function (e, r) {
        var a = o._plugins[r],
            u = t(n).find("[data-" + r + "]").addBack("[data-" + r + "]");u.each(function () {
          var n = t(this),
              e = {};if (n.data("zfPlugin")) return void console.warn("Tried to initialize " + r + " on an element that already has a Foundation plugin.");if (n.attr("data-options")) {
            n.attr("data-options").split(";").forEach(function (t, n) {
              var o = t.split(":").map(function (t) {
                return t.trim();
              });o[0] && (e[o[0]] = i(o[1]));
            });
          }try {
            n.data("zfPlugin", new a(t(this), e));
          } catch (t) {
            console.error(t);
          } finally {
            return;
    ...
    }, getFnName: n, transitionend: function transitionend(t) {
      var n,
          i = { transition: "transitionend", WebkitTransition: "webkitTransitionEnd", MozTransition: "transitionend", OTransition: "otransitionend" },
          e = document.createElement("div");for (var o in i) {
        "undefined" != typeof e.style[o] && (n = i[o]);
      }return n ? n : (n = setTimeout(function () {
        t.triggerHandler("transitionend", [t]);
      }, 1), "transitionend");
    } };r.util = { throttle: function throttle(t, n) {
    ...
    var e = typeof i === "undefined" ? "undefined" : _typeof(i),
        o = t("meta.foundation-mq"),
        a = t(".no-js");if (o.length || t('<meta class="foundation-mq">').appendTo(document.head), a.length && a.removeClass("no-js"), "undefined" === e) r.MediaQuery._init(), r.reflow(this);else {
      if ("string" !== e) throw new TypeError("We're sorry, " + e + " is not a valid parameter. You must use a string representing the method you wish to invoke.");var u = Array.prototype.slice.call(arguments, 1),
          s = this.data("zfPlugin");if (void 0 === s || void 0 === s[i]) throw new ReferenceError("We're sorry, '" + i + "' is not an available method for " + (s ? n(s) : "this element") + ".");1 === this.length ? s[i].apply(s, u) : this.each(function (n, e) {
        s[i].apply(t(e).data("zfPlugin"), u);
      });
    }return this;
  };window.Foundation = r, t.fn.foundation = a, function () {
    Date.now && window.Date.now || (window.Date.now = Date.now = function () {
      return new Date().getTime();
    });for (var t = ["webkit", "moz"], n = 0; n < t.length && !window.requestAnimationFrame; ++n) {
      var i = t[n];window.requestAnimationFrame = window[i + "RequestAnimationFrame"], window.cancelAnimationFrame = window[i + "CancelAnimationFrame"] || window[i + "CancelRequestAnimationFrame"];
    ...
    };return this.prototype && (e.prototype = this.prototype), o.prototype = new e(), o;
  });
}(jQuery);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
function _classCallCheck(t, i) {
  ...
  var i = function () {
    function i(e, s) {
      _classCallCheck(this, i), this.$element = e, this.options = t.extend({}, i.defaults, this.$element.data(), s), this._init(), Foundation.registerPlugin(this, "Orbit"), Foundation.Keyboard.register("Orbit", { ltr: { ARROW_RIGHT: "next", ARROW_LEFT: "previous" }, rtl: { ARROW_LEFT: "next", ARROW_RIGHT: "previous" } });
      ...
      } }, { key: "_setWrapperHeight", value: function value(i) {
        var e,
            s = 0,
            n = 0,
            o = this;this.$slides.each(function () {
          e = this.getBoundingClientRect().height, t(this).attr("data-slide", n), o.$slides.filter(".is-active")[0] !== o.$slides.eq(n)[0] && t(this).css({ position: "relative", display: "none" }), s = e > s ? e : s, n++;
        }), n === this.$slides.length && (this.$wrapper.css({ height: s }), i && i(s));
      } }, { key: "_setSlideHeight", value: function value(i) {
        this.$slides.each(function () {
          t(this).css("max-height", i);
        });
      } }, { key: "_events", value: function value() {
        var i = this;if (this.$element.off(".resizeme.zf.trigger").on({ "resizeme.zf.trigger": this._prepareForOrbit.bind(this) }), this.$slides.length > 1) {
          if (this.options.swipe && this.$slides.off("swipeleft.zf.orbit swiperight.zf.orbit").on("swipeleft.zf.orbit", function (t) {
            ...
            var e = this.$element.find("." + this.options.nextClass + ", ." + this.options.prevClass);e.attr("tabindex", 0).on("click.zf.orbit touchend.zf.orbit", function (e) {
              e.preventDefault(), i.changeSlide(t(this).hasClass(i.options.nextClass));
            });
          }this.options.bullets && this.$bullets.on("click.zf.orbit touchend.zf.orbit", function () {
            if (/is-active/g.test(this.className)) return !1;var e = t(this).data("slide"),
                s = e > i.$slides.filter(".is-active").data("slide"),
                n = i.$slides.eq(e);i.changeSlide(s, n, e);
          }), this.options.accessible && this.$wrapper.add(this.$bullets).on("keydown.zf.orbit", function (e) {
            Foundation.Keyboard.handleKey(e, "Orbit", { next: function next() {
                i.changeSlide(!0);
        ...
        "undefined" != typeof this.$slides && this.$slides.length > 1 && (this.$element.off(".zf.orbit").find("*").off(".zf.orbit"), this.options.autoPlay && this.timer.restart(), this.$slides.each(function (i) {
          t(i).removeClass("is-active is-active is-in").removeAttr("aria-live").hide();
        }), this.$slides.first().addClass("is-active").show(), this.$element.trigger("slidechange.zf.orbit", [this.$slides.first()]), this.options.bullets && this._updateBullets(0));
      } }, { key: "changeSlide", value: function value(t, i, e) {
        if (this.$slides) {
          var s = this.$slides.filter(".is-active").eq(0);if (/mui/g.test(s[0].className)) return !1;var n,
              o = this.$slides.first(),
              a = this.$slides.last(),
              l = t ? "Right" : "Left",
              r = t ? "Left" : "Right",
              h = this;n = i ? i : t ? this.options.infiniteWrap ? s.next("." + this.options.slideClass).length ? s.next("." + this.options.slideClass) : o : s.next("." + this.options.slideClass) : this.options.infiniteWrap ? s.prev("." + this.options.slideClass).length ? s.prev("." + this.options.slideClass) : a : s.prev("." + this.options.slideClass), n.length && (this.$element.trigger("beforeslidechange.zf.orbit", [s, n]), this.options.bullets && (e = e || this.$slides.index(n), this._updateBullets(e)), this.options.useMUI && !this.$element.is(":hidden") ? (Foundation.Motion.animateIn(n.addClass("is-active").css({ position: "absolute", top: 0 }), this.options["animInFrom" + l], function () {
            n.css({ position: "relative", display: "block" }).attr("aria-live", "polite");
          }), Foundation.Motion.animateOut(s.removeClass("is-active"), this.options["animOutTo" + r], function () {
            s.removeAttr("aria-live"), h.options.autoPlay && !h.timer.isPaused && h.timer.restart();
          })) : (s.removeClass("is-active is-in").removeAttr("aria-live").hide(), n.addClass("is-active is-in").attr("aria-live", "polite").show(), this.options.autoPlay && !this.timer.isPaused && this.timer.restart()), this.$element.trigger("slidechange.zf.orbit", [n]));
        }
      } }, { key: "_updateBullets", value: function value(t) {
        var i = this.$element.find("." + this.options.boxOfBullets).find(".is-active").removeClass("is-active").blur(),
            e = i.find("span:last").detach();this.$bullets.eq(t).addClass("is-active").append(e);
      } }, { key: "destroy", value: function value() {
  ...
  var e = function () {
    function e(i, n) {
      _classCallCheck(this, e), this.$element = i, this.options = t.extend({}, e.defaults, this.$element.data(), n), this._init(), Foundation.registerPlugin(this, "Tabs"), Foundation.Keyboard.register("Tabs", { ENTER: "open", SPACE: "open", ARROW_RIGHT: "next", ARROW_UP: "previous", ARROW_DOWN: "next", ARROW_LEFT: "previous" });
        ...
        var e = this,
            i = this;if (this.$element.attr({ role: "tablist" }), this.$tabTitles = this.$element.find("." + this.options.linkClass), this.$tabContent = t('[data-tabs-content="' + this.$element[0].id + '"]'), this.$tabTitles.each(function () {
          var e = t(this),
              n = e.find("a"),
              a = e.hasClass("" + i.options.linkActiveClass),
              s = n[0].hash.slice(1),
              o = n[0].id ? n[0].id : s + "-label",
              l = t("#" + s);e.attr({ role: "presentation" }), n.attr({ role: "tab", "aria-controls": s, "aria-selected": a, id: o }), l.attr({ role: "tabpanel", "aria-hidden": !a, "aria-labelledby": o }), a && i.options.autoFocus && t(window).load(function () {
            t("html, body").animate({ scrollTop: e.offset().top }, i.options.deepLinkSmudgeDelay, function () {
              n.focus();
            });
          });
        }), this.options.matchHeight) {
          var n = this.$tabContent.find("img");n.length ? Foundation.onImagesLoaded(n, this._setHeight.bind(this)) : this._setHeight();
        }this._checkDeepLink = function () {
          var i = window.location.hash;if (i.length) {
            var n = e.$element.find('[href="' + i + '"]');if (n.length) {
              if (e.selectTab(t(i), !0), e.options.deepLinkSmudge) {
                var a = e.$element.offset();t("html, body").animate({ scrollTop: a.top }, e.options.deepLinkSmudgeDelay);
        ...
        var e = this;this.$tabTitles.off("keydown.zf.tabs").on("keydown.zf.tabs", function (i) {
          if (9 !== i.which) {
            var n,
                a,
                s = t(this),
                o = s.parent("ul").children("li");o.each(function (i) {
              if (t(this).is(s)) return void (e.options.wrapOnKeys ? (n = 0 === i ? o.last() : o.eq(i - 1), a = i === o.length - 1 ? o.first() : o.eq(i + 1)) : (n = o.eq(Math.max(0, i - 1)), a = o.eq(Math.min(i + 1, o.length - 1))));
        ...
        if (t.hasClass("" + this.options.linkActiveClass)) return void (this.options.activeCollapse && (this._collapseTab(t), this.$element.trigger("collapse.zf.tabs", [t])));var i = this.$element.find("." + this.options.linkClass + "." + this.options.linkActiveClass),
            n = t.find('[role="tab"]'),
            a = n[0].hash,
            s = this.$tabContent.find(a);if (this._collapseTab(i), this._openTab(t), this.options.deepLink && !e) {
          var o = t.find("a").attr("href");this.options.updateHistory ? history.pushState({}, "", o) : history.replaceState({}, "", o);
        ...
        var e = t.find('[role="tab"]'),
            i = e[0].hash,
            n = this.$tabContent.find(i);t.addClass("" + this.options.linkActiveClass), e.attr({ "aria-selected": "true" }), n.addClass("" + this.options.panelActiveClass).attr({ "aria-hidden": "false" });
      } }, { key: "_collapseTab", value: function value(e) {
        var i = e.removeClass("" + this.options.linkActiveClass).find('[role="tab"]').attr({ "aria-selected": "false" });t("#" + i.attr("aria-controls")).removeClass("" + this.options.panelActiveClass).attr({ "aria-hidden": "true" });
        ...
        var e = 0,
            i = this;this.$tabContent.find("." + this.options.panelClass).css("height", "").each(function () {
          var n = t(this),
              a = n.hasClass("" + i.options.panelActiveClass);a || n.css({ visibility: "hidden", display: "block" });var s = this.getBoundingClientRect().height;a || n.css({ visibility: "", display: "" }), e = s > e ? s : e;
        }).css("height", e + "px");
      } }, { key: "destroy", value: function value() {
...
!function (n, e) {
   true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0)], __WEBPACK_AMD_DEFINE_FACTORY__ = (e),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = e(require("jquery")) : n.MotionUI = e(n.jQuery);
  ...
  function e(e, a, r, u) {
    function s() {
      ...
      if (null === o) return e ? a.show() : a.hide(), void u();var d = e ? i[0] : i[1],
          c = e ? t[0] : t[1];m(), a.addClass(r), a.css("transition", "none"), requestAnimationFrame(function () {
    ...
    Date.now || (Date.now = function () {
      ...
      var t = 0;window.requestAnimationFrame = function (n) {
        var e = Date.now(),
            i = Math.max(t + 16, e);return setTimeout(function () {
          n(t = i);
        }, i - e);
      }, window.cancelAnimationFrame = clearTimeout;
    }
    ...
    var n = { transition: "transitionend", WebkitTransition: "webkitTransitionEnd", MozTransition: "transitionend", OTransition: "otransitionend" },
        e = window.document.createElement("div");for (var i in n) {
      if ("undefined" != typeof e.style[i]) return n[i];
    }return null;
  }(),
      a = { animateIn: function animateIn(n, i, t) {
      e(!0, n, i, t);
    }, animateOut: function animateOut(n, i, t) {
      e(!1, n, i, t);
    } };return a;
